      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/15 transition">
            <h3 className="text-xl font-bold mb-0.5 text-[#FFF9C4]">{t('pricing.low_season.title')}</h3>
            <p className="text-[10px] text-[#FFF9C4]/70 mb-3 uppercase tracking-wider font-medium">{t('pricing.low_season.dates')}</p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/15 transition">
            <h3 className="text-xl font-bold mb-0.5 text-[#FFF9C4]">{t('pricing.high_season.title')}</h3>
            <p className="text-[10px] text-[#FFF9C4]/70 mb-3 uppercase tracking-wider font-medium">{t('pricing.high_season.dates')}</p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/15 transition">
            <h3 className="text-xl font-bold mb-0.5 text-[#FFF9C4]">{t('pricing.sunset.title')}</h3>
            <p className="text-[10px] text-[#FFF9C4]/70 mb-3 uppercase tracking-wider font-medium">{t('pricing.sunset.dates')}</p>

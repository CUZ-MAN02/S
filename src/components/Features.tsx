        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-2xl shadow-lg ring-1 ring-slate-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
              >
                <div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-amber-400 to-amber-500 rounded-xl flex items-center justify-center mb-4 md:mb-6 shadow-md">

...
export default function Boat() {
  ...
  return (
    <section id="boat" className="py-12 md:py-20 px-4 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
      <div className="max-w-7xl mx-auto">
        ...
        {lightboxIndex !== null && (
          ...
          >
              {/* Frecce esterne, sempre ai bordi dello schermo */}
              <button
                onClick={(e) => {
                  e.stopPropagation();
                ...
                className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-1.5 md:p-3 rounded-full opacity-100 transition-all z-50"
              ...
              <button
                ...
                className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-1.5 md:p-3 rounded-full opacity-100 transition-all z-50"

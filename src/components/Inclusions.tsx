    ...
    <section className="py-12 md:py-20 px-4 bg-gradient-to-br from-blue-50 to-cyan-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
          <div className="bg-[#FFFDF0] rounded-2xl shadow-lg p-6 md:p-8 border-2 border-blue-500">
            <h3 className="text-xl md:text-2xl font-bold text-[#1e3a8a] mb-4 md:mb-6 flex items-center gap-2">
            ...
            <ul className="space-y-3 md:space-y-4">
              {included.map((item, index) => (
                <li key={index} className="flex items-start gap-3">
                  ...
                  <span className="text-base md:text-lg text-[#334155]">{item}</span>
                </li>
              ))}
            </ul>
          </div>

          <div className="bg-[#FFFDF0] rounded-2xl shadow-lg p-6 md:p-8 border-2 border-amber-500">
            <h3 className="text-xl md:text-2xl font-bold text-[#1e3a8a] mb-4 md:mb-6 flex items-center gap-2">
            ...
            <ul className="space-y-3 md:space-y-4">
              {extras.map((item, index) => (
                <li key={index} className="flex items-start gap-3">
                  <div className="w-5 h-5 md:w-6 md:h-6 bg-amber-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
